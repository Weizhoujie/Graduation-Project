...
<script type="text/javascript">
        function check(){
    		...
    		var faculty=document.getElementById("faculty-1").value;
                ...
                <button  style="width: 100px;font-size: 20px;margin-left: 1000px;" id="upload" class="btn btn-primary" data-toggle="modal" >批量导入</button>
                    ...
                    <form class="fm" action="${pageContext.request.contextPath }/InsertTeacherServlet" >
                        <table class="table table-hover table-bordered" style="width: 600px;margin-left: 330px;">
                            ...
                            <tr>
                                <th>学院</th>
                                <td><input type="text" name="faculty" class="form-control" id="faculty-1" value="${param.faculty}"/></td>
                            </tr>
                            <tr>
                                <th>职位</th>
                                <td>
                                	<input type="text" id="position" name="position" class="form-control" value="${param.position}" /> 
                            ...
                            <tr>
                                <th>介绍</th>
                                <td>
                                	<input type="text" id="intro" name="intro" class="form-control" value="${param.intro}" /> 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="fm" action="${pageContext.request.contextPath }/UploadFileServlet?filetype=excelforteacher" method="post" enctype="multipart/form-data">
