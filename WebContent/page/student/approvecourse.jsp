		...
		<table style="margin-top:10px" cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				...
				<tr>
					...
					<c:if test="${not empty approvecourses}">
						<table cellspacing="0"  cellpadding="1" rules="all"
							...
							<c:forEach items="${approvecourses }" var="course" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px;color: #22CC77;" align="center"
										width="4%" ><strong>等待审批</strong></td>
						...
						<c:if test="${ empty approvecourses}">
					       <h2>暂无数据</h2>   
				         </c:if>
					</td>
				</tr>
