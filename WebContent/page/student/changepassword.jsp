...
<body>
	...
	<div class="container">
            ...
            <form action="${pageContext.request.contextPath}/StudentChangePwServlet" onsubmit="return check(this)" method="POST" role="form" style="margin: 100px auto; width: 520px;">
                <legend>修改密码</legend>
