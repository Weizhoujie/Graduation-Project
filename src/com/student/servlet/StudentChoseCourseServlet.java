...
@WebServlet("/StudentChoseCourseServlet")
public class StudentChoseCourseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public StudentChoseCourseServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 request.getRequestDispatcher("/page/student/chosecourses.jsp").forward(request, response);
	}
