...
@WebServlet("/CourseForAttendenceServlet")
public class CourseForAttendenceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public CourseForAttendenceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 request.getRequestDispatcher("/page/teacher/courseforattendence.jsp").forward(request, response);
	}
